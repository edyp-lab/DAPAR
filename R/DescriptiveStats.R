...
#' @importFrom Biobase exprs pData
#' @importFrom highcharter hcboxplot
...
#' @importFrom RColorBrewer brewer.pal
#' @importFrom highcharter highchart2
#' @export
...
wrapper.corrMatrixD_HC <- function(obj, rate=0.5){
  ...
  DAPAR::corrMatrixD_HC(data,samplesData, rate)
}
...
#' @importFrom highcharter list_parse2 highchart
#' @importFrom DT JS
