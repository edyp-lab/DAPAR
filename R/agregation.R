...
#' protData <- aggregateMean(obj.pep, as.matrix(M))
...
#' M <- BuildAdjacencyMatrix(obj.pep, protID, FALSE)
#' data <- Biobase::fData(obj.pep)
#' protData <- aggregateSum(obj.pep, as.matrix(M))
#' name <- "Protein_group_IDs"
#' proteinNames <- rownames(Biobase::fData(protData))
...
#' aggregateSum(obj.pep, as.matrix(X))
...
#' obj.pep <- Exp1_R25_pept[1:1000]
#' X <- BuildAdjacencyMatrix(obj.pep, protID, FALSE)
#' aggregateIterParallel(obj.pep, as.matrix(X))
#' 
...
#' obj.pep <- Exp1_R25_pept[1:1000]
#' X <- BuildAdjacencyMatrix(obj.pep, protID, FALSE)
#' inner.aggregate.iter(exprs(obj.pep), X)
...
#' aggregateIter(Exp1_R25_pept[1:1000],X=as.matrix(X))
...
#' protID <- "Protein_group_IDs"
#' X <- BuildAdjacencyMatrix(obj.pep, protID, FALSE)
#' aggregateMean(obj.pep, as.matrix(X))
...
#' protID <- "Protein_group_IDs"
#' X <- BuildAdjacencyMatrix(obj.pep, protID, FALSE)
#' aggregateTopn(obj.pep, as.matrix(X), n=3)
