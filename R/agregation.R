...
#' @export
BuildListAdjacencyMatrices <- function(obj.pep, protID){
  ...
  # }
  # 
  Xshared <- Matrix::Matrix(tmpShared, sparse=T,dimnames = list(rownames(obj.pep), colnames(t)))
  Xspec <- Matrix::Matrix(tmpSpec, sparse=T,dimnames = list(rownames(obj.pep), colnames(t)))
  t <- Matrix::Matrix(t, sparse=T,dimnames = list(rownames(obj.pep), colnames(t)))
  
  return (list(all = t, onlyShared = Xshared, onlySpec = Xspec))
}
...
#' @export
BuildAdjacencyMatrix <- function(obj.pep, protID, unique=FALSE){
  ...
  # }
  # 
  X <- Matrix::Matrix(t, dimnames = list(rownames(obj.pep), colnames(t))
  )
