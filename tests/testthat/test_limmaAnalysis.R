...
test_that("limmaCompleteTest", {
    ...
    m1 <- data.frame(logFC = c(-0.4072, -0.6320, -0.3365, -0.2288,  0.2328, -0.1919, -0.1739, -0.1149, -0.0546, -0.0260, -0.0213),
                    ...
                    P.Value = c(0.0014, 0.0018, 0.0021, 0.0203, 0.1536, 0.1825, 0.2476, 0.3654, 0.7153, 0.9328, 0.9367),
                    adj.P.Val = c(0.0077, 0.0077, 0.0077, 0.0558, 0.3346, 0.3346, 0.3891, 0.5024, 0.8743, 0.9367, 0.9367),
    ...
    m2 <- data.frame(X..Condition1....1....Condition2....1 = c(-0.4072, -0.6320, -0.3365, -0.2288,  0.2328, -0.1919, -0.1739, -0.1149, -0.0546, -0.0260, -0.0213),
                     X..Condition2....1....Condition1....1 = c(0.4072,  0.6320,  0.3365,  0.2288, -0.2328,  0.1919,  0.1739,  0.1149,  0.0546, 0.0260, 0.0213),
                     AveExpr = c(26.5604, 24.5760, 26.3923, 27.6750, 23.1868, 24.9437, 23.0873, 25.5138, 25.4416, 21.2579, 23.2761),
