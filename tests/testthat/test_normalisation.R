...
funcNorm <- wrapper.normalizeD(test, "Global Alignment", "sum by columns")
...
test_that("Wrapper / Global Alignment, quantile alignment", {
    ...
    funcNorm <- wrapper.normalizeD(test, "Global Alignment", "quantile alignment")
    expect_equal(round(Biobase::exprs(funcNorm),4), norm)
...
test_that("Wrapper / Median Centering, overall", {

    norm <- matrix(c(21.0366, 20.9296, 20.8467, 22.2453, 21.1927, 21.8866,
                     32.2029, 32.0795, 31.9828, 33.4473, 32.7212, 33.0244,
                     31.0437, 30.9149, 30.9001, 30.7312, 30.0421, 30.3222,
                     25.3471, 25.6837, 25.6865, 25.7737, 25.7702, 25.9684,
                     29.0045, 28.9954, 28.6950, 30.2681, 29.6169, 29.7529,
                     23.5960, 22.0934, 22.7829, 23.5112, 21.9586, 22.6471,
                     25.2144, 24.7273, 25.2381, 24.0705,      NA, 23.7618,
                     22.6170, 23.0437, 22.7208, 23.5389, 22.6613, 23.2009,
                     26.1933, 25.8566, 25.8539, 27.2590, 26.5681, 26.9598,
                     26.5097, 26.3203, 26.3241, 25.7667, 25.3046, 25.5720),10,6, byrow=TRUE)
...
test_that("Wrapper / Median Centering, within conditions", {
    
    norm <- matrix(c(21.4015, 21.2946, 21.2116, 21.7315, 20.6789, 21.3728,
                     32.5679, 32.4444, 32.3477, 32.9335, 32.2074, 32.5106,
                     31.4087, 31.2799, 31.2650, 30.2174, 29.5283, 29.8085,
                     25.7120, 26.0487, 26.0514, 25.2599, 25.2564, 25.4546,
                     29.3695, 29.3604, 29.0599, 29.7543, 29.1032, 29.2391,
                     23.9609, 22.4583, 23.1479, 22.9974, 21.4448, 22.1333,
                     25.5793, 25.0922, 25.6030, 23.5567,      NA, 23.2480,
                     22.9819, 23.4086, 23.0857, 23.0251, 22.1475, 22.6871,
                     26.5582, 26.2216, 26.2188, 26.7452, 26.0543, 26.4460,
                     26.8746, 26.6853, 26.6890, 25.2529, 24.7908, 25.0582),10,6, byrow=TRUE)
...
test_that("Wrapper / Mean Centering, within conditions", {
...
test_that("Wrapper / Mean Centering, overall", {
...
test_that("Wrapper / Mean Centering Scaling, overall", {
...
test_that("Wrapper / Mean Centering Scaling, within conditions", {
    
    norm <- matrix(c(25.0770, 25.1435, 25.0727, 24.6204, 24.5483, 24.6175,
                     28.1957, 28.1769, 28.1823, 27.6450, 27.4570, 27.6271,
                     27.8719, 27.8601, 27.8800, 26.9116, 26.7811, 26.8969,
                     26.2809, 26.4369, 26.4241, 25.5730, 25.7032, 25.7205,
                     27.3024, 27.3379, 27.2642, 26.7866, 26.6738, 26.7431,
                     25.7918, 25.4601, 25.6134, 24.9622, 24.7415, 24.8230,
                     26.2438, 26.1767, 26.2989, 25.1132,      NA, 25.1242,
                     25.5184, 25.7187, 25.5960, 24.9696, 24.9188, 24.9727,
                     26.5172, 26.4839, 26.4709, 25.9741, 25.9046, 25.9884,
                     26.6056, 26.6101, 26.6022, 25.5712, 25.5858, 25.6134),10,6, byrow=TRUE)
